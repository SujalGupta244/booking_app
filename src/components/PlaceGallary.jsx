...
const {imagesURL} = useLink()

const PlaceGallary = (props) => {
        ...
        return (
            <div className="absolute inset-0 bg-black text-white min-h-screen ">
                <div className="p-8 grid gap-4 bg-black ">
                    <div >
                        <h2 className="text-3xl md:w-3/6 md:m-auto mr-48">Photos of {title}</h2>
                        <button onClick={()=> setShowAllPhotos(false)} className='fixed right-12 top-8 flex gap-1 px-4 py-2 rounded-2xl shadow shadow-black bg-white text-black'>
