...
import { addUser, selectReady } from "../features/auth/authSlice";
import axios from "axios";
import useAuth from "../hooks/useAuth";
import useLink from "../hooks/useLink";

const {refreshURL} = useLink()
const Header = () => {
  ...
  return (
    <header className="flex justify-between">
      ...
      <Link
          to={token ? "/account":"/login"} className="flex items-center gap-2 border border-gray-300 rounded-full py-2 px-4">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
